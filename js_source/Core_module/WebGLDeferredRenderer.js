...
THREE.WebGLDeferredRenderer = function ( parameters ) {
	...
	var initDeferredMaterials = function ( object ) {
		...
		if ( object.material instanceof THREE.MeshFaceMaterial ) {
			...
			console.log("THREE.MeshFaceMaterial")
			var colorMaterials = [];
	...
	var createDeferredMaterials = function ( originalMaterial ) {
		...
		console.log("copyGammaToLinear - emissive "+ emissive);
		uniforms.emissive.value.copyGammaToLinear( emissive );
		console.log("copyGammaToLinear - diffuse"+ diffuse);
		uniforms.diffuse.value.copyGammaToLinear( diffuse );
		console.log("copyGammaToLinear - specular");
		...
		console.log("end of copyGammaToLinear");
	...
	var createRenderTargets = function ( ) {
		...
		// final composer
console.log("shader pass composite shader");
		...
		// FXAA
		console.log("shader pass THREE.FXAAShader");
